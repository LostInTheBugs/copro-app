...
from app.routes import auth, copro, lots, comptes, ag, documents, carnet, export, email, relances, travaux, consolide
...
for r in (auth, copro, lots, comptes, ag, documents, carnet, export, email, relances, travaux, consolide):
